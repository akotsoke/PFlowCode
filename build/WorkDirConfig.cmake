...
if( NOT WorkDir_FIND_QUIETLY )
   message( STATUS "Found WorkDir: "
      "${WorkDir_ROOT_DIR} (version: 21.2.29)" )
endif()
...
set( WorkDir_BASE_PROJECTS AnalysisBase;21.2.29 )
...
set( WorkDir_PACKAGE_NAMES TaggingUtilities;fjvtTagAndProbe )
...
if( WorkDir_FIND_COMPONENTS )
   ...
   if( ATLAS_RELEASE_RECOMPILE )
      ...
      set( WorkDir_TARGET_NAMES TaggingUtilitiesPkg;TaggingUtilitiesPkgPrivate;TaggingUtilitiesLib;fjvtTagAndProbePkg;fjvtTagAndProbePkgPrivate;fjvtTagAndProbeLib )
